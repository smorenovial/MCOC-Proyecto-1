...
u_k = ones((Nx+1,Ny+1), dtype=double)   #dtype es el tipo de datos (double, float, int32, int16...)
u_km1 = ones((Nx+1,Ny+1), dtype=double)   #dtype es el tipo de datos (double, float, int32, int16...)
...
for k in range(int32(1./dt)):
    t = dt*(k+1)
    Q = Hu * 220 * ((15.0/t)**0.781429) * (0.781429/t) * 0.75 * exp(-(15.0/t)**0.781429) * exp(27.8284/8.314472*(1/(273+79)-1/(273+21)))
    print "k = ", k, " t = ", t
	u_k = Q * ones((Nx+1,Ny+1), dtype=double)   #dtype es el tipo de datos (double, float, int32, int16...)
	u_km1 = Q * ones((Nx+1,Ny+1), dtype=double)   #dtype es el tipo de datos (double, float, int32, int16...)
    #CB esencial
    # u_k[0,:] = 20.
    # u_k[-1,:] = 20.
