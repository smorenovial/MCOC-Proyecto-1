...
for k in range (70000):
	...
	print "k =", k, "t =", t
	if k==0:	
		u_k[0] = 0.            #En el primer caso cuando k es 0, la condicion de borde es 0 
		u_k[n] = 20.
	else:
		u_k[0] = u_k[1]        # Luego la condicion de borde va aumentando a la misma tasa de crecida que 1 "n" de profundidad del
		u_k[n] = 20.           # material, obligando a que aumente su temperatura hasta alcanzar la igualacion de calor a cada lado en 20.
